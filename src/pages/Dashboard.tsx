...
import { Search, Star, Mail, Book, Beaker, Globe, Apple, LogOut, Wand2, Bot, History, Rocket, Heart, GraduationCap, Share2, UserPlus, Zap } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const sidebarItems = [
    { name: 'Magic Tools', icon: <Wand2 className="w-6 h-6" />, link: '/magic-tools' },
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-64 bg-white shadow-lg">
        <div className="p-4">
          <h1 className="text-3xl font-bold text-purple-600 mb-8">Magic School</h1>
